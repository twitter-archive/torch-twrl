...
th testScript.lua -env 'CartPole-v0' -policy categorical -learningUpdate reinforce -model singleHiddenLayerCategorical -nSteps 1000 -nIterations 5 -timestepsPerBatch 1000 -stepsizeStart 0.3 -gamma 1 -nHiddenLayerSize 10 -video 0 -gradClip 5 -baselineType padTimeDepAvReturn -renderAllSteps false -beta 0.01 -weightDecay 0.9 -windowSize 100 -uploadResults true